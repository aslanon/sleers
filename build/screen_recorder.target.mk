...
DEFS_Debug := \
	'-DNODE_GYP_MODULE_NAME=screen_recorder' \
	'-DUSING_UV_SHARED=1' \
	'-DUSING_V8_SHARED=1' \
...
OBJS := \
	$(obj).target/$(TARGET)/native/screen_recorder.o
...
$(builddir)/screen_recorder.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/screen_recorder.node: LIBS := $(LIBS)
$(builddir)/screen_recorder.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/screen_recorder.node: TOOLSET := $(TOOLSET)
$(builddir)/screen_recorder.node: $(OBJS) $(builddir)/nothing.a FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/screen_recorder.node
# Add target alias
.PHONY: screen_recorder
screen_recorder: $(builddir)/screen_recorder.node

# Short alias for building this executable.
.PHONY: screen_recorder.node
screen_recorder.node: $(builddir)/screen_recorder.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/screen_recorder.node
